  ...
  <>
   ...
   <header>
    <div className="h-[120px]">
     <div className=" z-40 flex items-center shadow-sticky justify-between left-0 z-40 w-full transition-all duration-300 top-0  fixed bg-white/80 py-3 shadow-sticky backdrop-blur-[15px] backdrop-saturate-[150%] dark:bg-tg-dark-bg lg:py-0">
      ...
      <div className="flex w-full items-center justify-between px-4">
       ...
       <div className="hidden justify-end pr-16 sm:flex lg:pr-0">
        <a href="/#" className="rounded-lg bg-black py-3 px-7 text-base font-medium text-white hover:bg-opacity-90">
         Get Started
        </a>
       </div>
      </div>
