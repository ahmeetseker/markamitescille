   ...
   <section>
    <div className="container mx-auto">
     ...
     <div className="col-span-2">
      <p>
       MarkamıTescille, ticaret ve rekabet ortamını zenginleştiren en önemli unsur olan markaları bir dikey uzmanlık alanı olarak seçerek öncelikli olarak marka tescili ve patent işlemleri konusunda hizmet verme amaçlı kurulmuştur. Fikri ve
       Sınai Haklar Hukuku alanında aktif olarak faaliyette bulunan şahıslarca yönetilen firmamız, Türk Patent ve Marka Kurumu nezdindeki işlemleri sektörde pek karşılanamayan bir talep olan hukuk süzgecinden geçirerek gerçekleştirmeyi ilke
       edinmiştir.
      </p>
